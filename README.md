# COMDEX
Source code to the [COMDEX.io](https://comdex.io) single html file wallet and commodity trading tool. The philosophy  behind COMDEX is to provide a simple transparent commodity marketplace on the Stellar network where genuinely redeemable tokenized assets on the SDEX can be bought, traded and speculated on according to their international market spot price.
...
If you would like to contribute some code to this open source tool please feel free to contact admin at comdex.io
